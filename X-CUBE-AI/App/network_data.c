...
ai_buffer g_network_data_map_activations[AI_NETWORK_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    3760, NULL, 0x20000000),    /* POOL_0_DTCMRAM */
  };
ai_buffer g_network_data_map_weights[AI_NETWORK_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 100352, 1, 1),
    100352, NULL, s_network__Relu_output_0_weights_array_u64),   /* _Relu_output_0_weights_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 512, 1, 1),
    512, NULL, s_network__Relu_output_0_bias_array_u64),   /* _Relu_output_0_bias_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 8192, 1, 1),
    8192, NULL, s_network__Relu_1_output_0_weights_array_u64),   /* _Relu_1_output_0_weights_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 256, 1, 1),
    256, NULL, s_network__Relu_1_output_0_bias_array_u64),   /* _Relu_1_output_0_bias_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 640, 1, 1),
    640, NULL, s_network_output_QuantizeLinear_Input_weights_array_u64),   /* output_QuantizeLinear_Input_weights_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 40, 1, 1),
    40, NULL, s_network_output_QuantizeLinear_Input_bias_array_u64),   /* output_QuantizeLinear_Input_bias_array */
  };
